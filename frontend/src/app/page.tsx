      ...
      <header className="sticky top-0 z-50 bg-white border-b-4 border-black px-6 py-4 shadow-[0_4px_0_0_#000]">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link 
              href="/login"
              className="bg-black text-yellow-300 font-black px-6 py-2.5 text-xs uppercase border-2 border-black shadow-[3px_3px_0_0_#000] hover:bg-gray-800 active:translate-x-0.5 active:translate-y-0.5 transition-all flex items-center gap-1.5"
            >
              <LogIn className="w-3.5 h-3.5 text-yellow-300"/> LOGIN SUPERADMIN
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <Link 
                  href="/login"
                  className="bg-black text-yellow-300 font-black text-sm uppercase px-8 py-4 border-4 border-black shadow-[6px_6px_0_0_#000] hover:bg-gray-800 active:translate-x-1 active:translate-y-1 active:shadow-none transition-all flex items-center gap-2"
                >
